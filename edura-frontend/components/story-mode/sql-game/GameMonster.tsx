...
export default function GameMonster({ monster, position }: GameMonsterProps) {
  ...
  return (
    <div 
      ...
      style={{ left: `${position}%` }}
    >
      <div className="relative w-56 h-60 overflow-hidden rounded-lg border-4 border-orange-600 shadow-lg bg-orange-50/90">
      ...
      <div className="absolute -top-8 left-1/2 transform -translate-x-1/2 bg-orange-700 text-white px-3 py-1 rounded-lg text-sm font-bold whitespace-nowrap shadow-md border border-orange-500 z-20">
        {monster.name}
      </div>
    </div>
  )
